...
public class PlayerDialogOverlay extends Overlay {
    ...
    private final DialogAccessibilityConfig config;
    private final DialogAccessibilityPlugin plugin;

    @Inject
    private PlayerDialogOverlay(Client client, DialogAccessibilityPlugin plugin, DialogAccessibilityConfig config)
    {
